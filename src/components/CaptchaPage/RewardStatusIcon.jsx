...
export default function RewardStatusIcon({ success }) {
  ...
  return (
    <div className={styles.iconContainer}>
      ...
      <div className={`${styles.rotatingOuterRing} ${success ? styles.successOuter : styles.failOuter}`}>
        <div className={styles.orbitingDot1} />
        <div className={styles.orbitingDot2} />
      </div>

      {/* Counter-rotating inner dotted ring */}
      <div className={`${styles.rotatingInnerRing} ${success ? styles.successInner : styles.failInner}`} />
